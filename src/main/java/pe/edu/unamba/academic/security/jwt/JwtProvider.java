...
import pe.edu.unamba.academic.security.config.PrimaryUser;
...
public class JwtProvider {
    ...
    // Genera el token JWT para un usuario específico:
    public String generateJwtByUsername(UserInfo user) {
        // Creamos la instancia de PrimaryUser a partir del user
        PrimaryUser usuarioPrincipal = PrimaryUser.build(user);

        // Obtenemos la lista de roles (en este caso, un solo rol) como String

...
public final class ApiErrorResponse {
    ...
    public static ResponseEntity<ApiErrorResponse> conflict(Collection<ApiError> errors, String message) {
    ...
    public static ResponseEntity<ApiErrorResponse> internalServerError(String message, String details) {
        return ResponseEntity.internalServerError()
                .contentType(APPLICATION_JSON)
                .body(ApiErrorResponse.builder()
                        .httpStatus(INTERNAL_SERVER_ERROR)
    ...
    public static ResponseEntity<ApiErrorResponse> internalServerError(String message, Collection<ApiError> errors) {
        return ResponseEntity.internalServerError()
                .contentType(APPLICATION_JSON)
                .body(ApiErrorResponse.builder()
                        .httpStatus(INTERNAL_SERVER_ERROR)
    ...
    public static ResponseEntity<ApiErrorResponse> notFound(String message, String instance) {
